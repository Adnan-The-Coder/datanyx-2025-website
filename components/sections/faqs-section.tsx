...
const FAQS = [
  ...
  {q:"Who can we contact for queries or assistance?",a:"For any questions or support, participants can reach out through the contact on the website or connect with the organizing team via email or social media handles provided below."},
